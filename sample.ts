...
app.get('/authorize', (req, res) => {  
  ...
  try {
    ...
    return res.status(500).json({ error: 'internal_server_error', error_description: 'Failed to construct authorization URL' });
  }
});  
...
async function handlePostMessage(req: express.Request, res: express.Response) {
